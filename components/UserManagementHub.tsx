...
const USERS: User[] = [
  ...
  { id: '4', email: 'emma.collector@gmail.com', name: 'Emma Collector', avatar: '👩', plan: 'pro', status: 'active', joinedAt: '2024-11-10', lastActive: '3 hours ago', totalSpent: 89, creditsUsed: 2300, apps: ['JavariCardverse', 'Javari Spirits'], country: 'AU', riskScore: 8 },
